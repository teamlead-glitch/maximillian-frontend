...
px-4 sm:px-0 text-center">
                ...
                <div className="max-w-[1300px] mx-auto py-10 md:py-10 mxl:py-20 px-5">
                    <div className="flex flex-wrap items-center gap-5 justify-center">
                        <div className="text-var(--color-secondary) font-my-font-semibold">Overview</div>
                        <div className="text-var(--color-secondary) font-my-font-semibold">Journeys</div>
                        <div className="text-var(--color-secondary) font-my-font-semibold">Inspirations</div>
                    </div>
                </div>

            </section >
            <section className="relative  py-10 px-5 overflow-hidden bg-white">
                <div className="max-w-[1300px] mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-5">
                        <div className="pr-0 md:pr-15 xl:pr-32">
            ...
            <section className="relative  py-20 px-5 overflow-hidden bg-white">
