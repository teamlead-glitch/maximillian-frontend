      ...
      >
        <div className="max-w-[1300px] flex items-center justify-between h-full flex-col gap-8 mx-auto  ">
          <div className="w-full flex flex-col items-start gap-5  pl-5 md:pl-10">
            ...
            />
            <Image
              src="images/tripadvisor-reviews.svg"
              alt=""
              className="w-40 md:w-auto"
              width="264"
              height="72"
          ...
          <div className="w-full pl-5 md:pl-10">
            ...
            <p className=" text-white mb-5 max-w-md line-clamp-4">
              Luxury travel isn’t about where you go. It’s about how it feels.
              Let us design a journey that reflects you.
            </p>
            <div className="flex gap-4">
              <Link href=""
                className=" relative overflow-hidden bg-white/30 backdrop-blur-md text-white cursor-pointer px-4 py-3 md:px-6 md:py-4 rounded-full font-my-font-semibold shadow-lg text-xs sm:text-base transition-all duration-300 hover:bg-white/40 before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r  before:from-transparent before:via-white/40 before:to-transparent before:transition-transform before:duration-700 hover:before:translate-x-full " >
