                ...
                <div className="max-w-[1300px] flex mx-auto  px-5  ">
                    <div className="w-full justify-center items-center">
                        ...
                        <ul className="flex flex-wrap justify-center items-center text-sm gap-2 mt-1 py-4">
                            {category && (
                                <li className={`relative text-(--color-secondary) ${(region.length > 0 || countries.length > 0) ? "relative pr-3 text-(--color-secondary) after:content-['|'] after:absolute after:right-0 after:top-1/2 after:-translate-y-1/2 after:text-(--color-secondary)" : ""}`}>
                                    {category}
                                </li>
                            )}
