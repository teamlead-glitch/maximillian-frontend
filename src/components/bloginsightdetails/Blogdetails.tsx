    ...
    return (
        <>
            <section className="relative pt-40 pb-10 overflow-hidden bg-white">
                <div className="max-w-[1300px] flex mx-auto  px-3  ">
                ...
                <div className="py-6 aspect-[4/1.5]">
            ...
            <section className="relative py-20 overflow-hidden bg-white">
                <div className="max-w-[1200px]  mx-auto  px-3  ">
                    ...
                    <div className="w-full justify-center grid grid-cols-[7fr_3fr] gap-3 py-10">
                        <div className="div">
                    ...
                    <div className="w-full mx-auto text-center  px-15 py-15">
                        <div className="text-center text-4xl font-dm-serif text-(--color-secondary)">“</div>
                        <p className="italic text-2xl">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam, saepe a porro nobis maxime incidunt quam dolore ducimus, iure repellendus molestiae! Fuga, rem. Unde, laborum delectus voluptate laudantium repellat quod? Lorem ipsum dolor.</p>
                        <div className="text-center text-4xl font-dm-serif text-(--color-secondary)">”</div>
                    ...
                    <div className="w-full py-15 justify-between grid grid-cols-[3fr_1fr] gap-3 border-t border-[#bfbdbd] pt-15 ">
                        <div className="flex  gap-3 pr-30">
                        ...
                        <div className="flex flex-col gap-2 items-end  justify-between">
                            <div className="flex flex-col items-end"><ul className="flex gap-2">
